...
For a quick preview, check this [YouTube example](https://www.youtube.com/watch?v=923FFy5cI-4). It represents only **~2–3%** of what we’re building—and the demo hardware is imprecise. MotionCoder aims for **complete, precise gesture coverage**, informed by my practical experience in gesture design and control.
