...
| **Sensor Guide**   | Sensor selection & integration guide: **how to choose the right camera module** (MIPI/RAW, global shutter, optics, filters, sync, etc.)                                        | Reference sensors/modules (OV9281, AR0234, …), lenses, band-pass IR          | Apache-2.0     | —                                                                       | —                     | [Sensor Guide](https://github.com/xtanai/sensor-guide) |
---
